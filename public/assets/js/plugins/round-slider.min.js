        ...
        for (; u < _; ) {
            ...
            if (null !== t) {
                if ((c++, 1 === t.nodeType)) {
                    ...
                    "TEMPLATE" === t.tagName &&
                        (r.push(t), (a.currentNode = t.content));
    ...
    static get observedAttributes() {
        ...
        return (
            this._classProperties.forEach((e, s) => {
                ...
                void 0 !== i &&
                    (this._attributeToPropertyMap.set(i, s), t.push(i));
            }),
            t
        );
    }
        ...
        if (
            (((t, s, i) => {
                ...
                void 0 === n &&
                    ...
                    R.set(
                        s,
                        (n = new N(Object.assign({ templateFactory: M }, i)))
                    ),
                    n.appendInto(s)),
                    n.setValue(t),
                    n.commit();
...
customElements.define(
    ...
    class extends Q {
        ...
        _angleInside(t) {
            let e =
                ((this.startAngle + this.arcLength / 2 - t + 180 + 360) % 360) -
                180;
        ...
        _angle2value(t) {
            return (
                Math.round(
                    ((t / this._len) * (this.max - this.min) + this.min) /
                        this.step
                ) * this.step
            );
        }
            ...
            if (e.classList.contains("shadowpath"))
                if (
                    ("touchstart" === t.type &&
                        (s = window.setTimeout(() => {
                            this._rotation &&
                                (this._rotation.cooldown = void 0);
                        }, 200)),
                    null == this.low)
                )
            ...
            ("ArrowLeft" !== t.key && "ArrowDown" !== t.key) ||
                ...
                ("ArrowRight" !== t.key && "ArrowUp" !== t.key) ||
                    ...
                    this.rtl
                        ...
                        : this._dragpos(this[e.id] + this.step)),
                "Home" === t.key &&
                    (t.preventDefault(), this._dragpos(this.min)),
                "End" === t.key &&
                    (t.preventDefault(), this._dragpos(this.max));
        }
        firstUpdated() {
      ...
      >
        ...
        ${
            this._showHandle
                ? null != this.low
                    ? this._reverseOrder
                        ? U`${this._renderHandle("high")} ${this._renderHandle(
                              "low"
                          )}`
                        : U`${this._renderHandle("low")} ${this._renderHandle(
                              "high"
                          )}`
    ...
    `;
      ...
      .bar {
        stroke: var(--round-slider-bar-color, #6c757d);
      }
      svg[disabled] .bar {
        stroke: var(--round-slider-disabled-bar-color, darkgray);
      }
      g.handles {
        stroke: var(--round-slider-handle-color, var(--round-slider-bar-color, #6c757d));
